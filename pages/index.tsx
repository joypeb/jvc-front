...
export default function Home() {
    ...
    return (
        <Fragment>
                ...
                <div className={styles.sns}>
                    ...
                    <div className={styles.snsList}>
                        <div className={styles.snsYoutube}>
                            <Link href="https://www.youtube.com/@joypch7"
                                  className={styles.snsLinkYoutube}>예수비전교회</Link>
                        </div>
                        <div className={styles.snsYoutube}>
                            <Link href="https://www.youtube.com/@user-jg2dq5ku8e"
                                  className={styles.snsLinkYoutube}>예닮아동부</Link>
                        </div>
                        <div className={styles.snsYoutube}>
                            <Link href="https://www.youtube.com/@user-ft2op3jb7j" className={styles.snsLinkYoutube}>VISION
                                FOREST</Link>
                        </div>
                        <div className={styles.snsYoutube}>
                            <Link href="https://www.youtube.com/@user-gk8it7zq4i" className={styles.snsLinkYoutube}>꿈땅
                                작은 도서관</Link>
                        </div>
            ...
            <div className={styles.sns2Box}>
                <div className={styles.sns2}>
                    <h1 className={styles.sns2Title}>유튜브와 인스타그램으로 말씀과 소식을 확인하세요</h1>
                    <div className={styles.sns2LinkBox}>
                        <div className={styles.sns2Youtube}>
                            <div className={styles.sns2ImgBox}>
                                <Image
                                    src="youtube.svg"
                                    alt="유튜브"
                                    width={40}
                            ...
                            <Link href="https://www.youtube.com/@joypch7"
                                  className={styles.sns2YoutubeText}>예수비전교회</Link>
                            <Link href="https://www.youtube.com/@user-jg2dq5ku8e"
                                  className={styles.sns2YoutubeText}>예닮아동부</Link>
                            <Link href="https://www.youtube.com/@user-ft2op3jb7j" className={styles.sns2YoutubeText}>VISION
                                FOREST</Link>
                            <Link href="https://www.youtube.com/@user-gk8it7zq4i" className={styles.sns2YoutubeText}>꿈땅
                                작은 도서관</Link>
                        </div>
                        <div className={styles.sns2Instagram}>
                            <div className={styles.sns2ImgBox}>
                                <Image
                                    src="instagram.svg"
                                    alt="인스타그램"
                                    width={40}
                                    height={40}
                                    className={styles.sns2Img}
                                />
                                <span>Instagram</span>
                            </div>
                            <Link href="https://www.instagram.com/forest__worship/" className={styles.sns2InstagramText}>VISION FOREST</Link>
                            <Link href="https://www.instagram.com/jvc_visionup/" className={styles.sns2InstagramText}>VISION UP</Link>
                        </div>
                    </div>
                </div>
            </div>
